...
export const ACTIONS = {
  ...
  BEGIN_ROUND: 'beginRound', // dismiss the round title card, show the first question
  ...
  GRADE_BONUS: 'gradeBonus', // { teamId, correct } — award a question's preset bonus points

  // Round 5 — Music buzzer
  MUSIC_SET_PLAYING: 'musicSetPlaying', // { playing } — host play/pause; TV plays the audio
  MUSIC_RESTART: 'musicRestart', // host: restart the clip from the beginning on the TV
...
// Upper safety cap on teams in a room. The host decides the real count by how many
// join requests they approve — there's no fixed 4-team layout anymore. This just
// stops a runaway/abusive room; bump it if you genuinely run bigger events.
...
export const DEFAULT_SCORING = {
  ...
  matchAllBonus: 5, // Round 2 extra if ALL pairs are correct
  jetSetter: 10, // Round 3 correct
  invisible: 10, // Round 4 correct
  emoji: 10, // Emoji round correct
